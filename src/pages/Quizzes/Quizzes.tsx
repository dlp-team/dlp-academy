...
const useQuizData = (user: any, subjectId: any, topicId: any, quizId: any, navigate: any, location: any) => {
    ...
    const [subjectIconKey, setSubjectIconKey] = useState<any>(null);
...
const QuizFallbackState = React.memo(({ title, message, onGoBack }: any) => (
            ...
            {quizData.formulas?.length > 0 && (
                <div className="mb-10 space-y-4">
                    ...
                    <div className="space-y-3">
                        {quizData.formulas.map((formula, idx: any) => (
