...
const ViewResource = () => {
    ...
    const [viewerReadyMap, setViewerReadyMap] = useState({});
    const [viewerErrorMap, setViewerErrorMap] = useState({});
    ...
    useEffect(() => {
        ...
        const timeoutId = setTimeout(() => {
            setViewerErrorMap((prev) => ({ ...prev, [viewerKey]: true }));
            setViewerReadyMap((prev) => ({ ...prev, [viewerKey]: false }));
        }, 12000);
        ...
        <div className="min-h-screen bg-slate-900 flex flex-col">
            ...
            <div className="flex-1 bg-slate-100 relative overflow-hidden">
                ...
                <iframe 
                    ...
                    allowFullScreen
                    onLoad={() => {
                        setViewerReadyMap((prev) => ({ ...prev, [viewerKey]: true }));
                        setViewerErrorMap((prev) => ({ ...prev, [viewerKey]: false }));
                    }}
                    onError={() => {
                        setViewerErrorMap((prev) => ({ ...prev, [viewerKey]: true }));
                        setViewerReadyMap((prev) => ({ ...prev, [viewerKey]: false }));
