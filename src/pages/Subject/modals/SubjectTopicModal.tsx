...
const SubjectTopicsModal = ({ isOpen, onClose, subject }: any) => {
    const [topics, setTopics] = useState<any[]>([]);
    const [loading, setLoading] = useState(true);
    const [loadError, setLoadError] = useState('');
    const [reorderError, setReorderError] = useState('');
    const [draggedTopicId, setDraggedTopicId] = useState<any>(null);
    ...
    const handleDrop = async (e, targetTopicId: any) => {
        e.preventDefault();
        ...
        try {
            ...
            newTopics.forEach((item, index: any) => { 
