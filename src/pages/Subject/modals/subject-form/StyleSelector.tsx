...
const StyleSelector = ({ formData, setFormData }: any) => {
    const [showModernFillOptions, setShowModernFillOptions] = React.useState(false);
                ...
                <div className="space-y-2 animate-in fade-in slide-in-from-top-2 duration-300">
                    ...
                    {showModernFillOptions && (
                        <div className="grid grid-cols-3 gap-3">
                            {MODERN_FILL_COLORS.map((fillColor: any) => (
                                <button
                                    key={fillColor.value}
                                    type="button"
                    ...
                    <div className="text-xs text-gray-500 dark:text-gray-400">
                        Seleccionado: {MODERN_FILL_COLORS.find(c => c.value === formData.modernFillColor)?.name || 'Ninguno'}
                    </div>
                </div>
            )}
        </div>
