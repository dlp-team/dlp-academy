...
const SubjectTestModal = ({
    ...
    const selectedTopicName = useMemo(
        () => topics.find((topic: any) => topic.id === formData.topicId)?.name || '',
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <label className="block">
                            ...
                            <select
                                ...
                                onChange={(event) => setFormData((prev: any) => ({ ...prev, topicId: event.target.value }))}
                                className="mt-2 w-full rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 px-3 py-2.5 text-sm font-semibold"
                                disabled={isSaving}
                            >
                        ...
                        <label className="block">
                            ...
                            <select
                                ...
                                onChange={(event) => setFormData((prev: any) => ({ ...prev, level: event.target.value }))}
                                className="mt-2 w-full rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 px-3 py-2.5 text-sm font-semibold"
                                disabled={isSaving}
                            >
                                {LEVEL_OPTIONS.map((option: any) => (
                        ...
                        <label className="block">
                            ...
                            <input
                                ...
                                onChange={(event) => setFormData((prev: any) => ({ ...prev, questionCount: event.target.value }))}
                                className="mt-2 w-full rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 px-3 py-2.5 text-sm font-semibold"
                                disabled={isSaving}
                            />
                        </label>
                            ...
                            <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-3">
                                <label className="block">
                                    ...
                                    <input
                                        ...
                                        onChange={(event) => setFormData((prev: any) => ({ ...prev, assignmentStartAt: event.target.value }))}
                                ...
                                <label className="block">
                                    ...
                                    <input
                                        ...
                                        onChange={(event) => setFormData((prev: any) => ({ ...prev, assignmentDueAt: event.target.value }))}
                                        className="mt-1.5 w-full rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 px-3 py-2 text-sm"
                                        disabled={isSaving}
                                    />
                                </label>
                                ...
                                <label className="block">
                                    ...
                                    <input
                                        ...
                                        onChange={(event) => setFormData((prev: any) => ({ ...prev, assignmentWeight: event.target.value }))}
                                        className="mt-1.5 w-full rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 px-3 py-2 text-sm"
                                        disabled={isSaving}
                                    />
                                </label>
