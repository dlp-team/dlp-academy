...
const QuestionDot = ({ index, isCurrent, isRevealed, gradient, onClick }) => (
    <button
        onClick={onClick}
...
const CompletionScreen = ({ examData, revealedAnswers, timeLeft, total, gradient, onRestart, onBack }) => {
...
const Exam = () => {
    ...
    const navigateQuestion = useCallback((targetIdx) => {
