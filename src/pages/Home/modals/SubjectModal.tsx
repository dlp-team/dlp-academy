...
const SubjectModal = ({ 
    ...
    useEffect(() => {
        ...
        openFormSnapshotRef.current = JSON.stringify(formData || {});
    }, [isOpen]);
    ...
    return (
        <DashboardOverlayShell
            ...
            maxWidth="md"
            backdropClassName="absolute inset-0 bg-black/50 backdrop-blur-sm animate-fadeIn"
            ...
            {({ requestClose }: any) => (
                <>
                    ...
                    <div className="px-6 py-4 border-b flex justify-between items-center bg-gray-50">
                        ...
                        <button onClick={requestClose} className="p-2 hover:bg-gray-200 rounded-full transition-colors">
