...
const HomeDeleteConfirmModal = ({ deleteConfig, setDeleteConfig, handleDelete }) => {
    ...
    return (
        <div className="fixed inset-x-0 bottom-0 top-24 z-50 flex items-center justify-center p-4 bg-black/50 dark:bg-black/70 backdrop-blur-sm transition-colors">
