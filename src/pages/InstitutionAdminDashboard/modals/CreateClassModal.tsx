...
const PersonPicker = ({
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="max-h-44 overflow-y-auto border border-gray-200 dark:border-slate-700 rounded-xl divide-y divide-gray-100 dark:divide-slate-700 minimal-scrollbar">
        {singleSelect && (
