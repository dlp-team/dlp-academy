                  ...
                  <div className="mt-8 flex flex-col sm:flex-row sm:items-center gap-6">
                    ...
                    <div className="space-y-4 text-sm text-slate-500 dark:text-slate-400">
                      <h3 className="text-2xl font-bold text-indigo-700 dark:text-indigo-300 mb-2">
                        Logotipo de {institutionName || customizationForm.institutionDisplayName || 'la institución'}
                      </h3>
                      <p className="text-base text-slate-600 dark:text-slate-300 mb-1">
                        Este logotipo se muestra en el encabezado de la aplicación y representa la identidad visual de <span className="font-semibold text-indigo-700 dark:text-indigo-300">{institutionName || customizationForm.institutionDisplayName || 'la institución'}</span>.
                      </p>
                      <p className="text-sm text-emerald-700 dark:text-emerald-300 mb-2">
                        {customizationForm.logoUrl ? 'Logotipo configurado y listo para el encabezado.' : 'Todavía no configurado.'}
                      </p>
                      <form
                        onSubmit={async (e) => {
                          e.preventDefault();
