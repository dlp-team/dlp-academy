  ...
  return (
    <div className={rootCls} style={{ background: '#e2e8f0' }}>
            ...
            <div className="px-4 py-4 space-y-4">
              ...
              <section>
                <div className="flex items-center justify-between mb-2.5">
                  ...
                  <span className="text-[10px] flex items-center gap-1 px-2 py-0.5 rounded-full font-medium" style={{ backgroundColor: hexToRgba(form.primary, 0.10), color: form.primary }}>
                    <Zap size={9} /> En vivo
                  </span>
                </div>
      ...
      <div className="flex-1 flex flex-col overflow-hidden min-w-0">
        ...
        {/* Active-token banner */}
        {activeToken && (
          <div className="flex items-center gap-2 px-4 py-2 text-xs font-medium border-b shrink-0 transition-all" style={{ backgroundColor: hexToRgba(form[activeToken], 0.08), borderColor: hexToRgba(form[activeToken], 0.25), color: form[activeToken] }}>
