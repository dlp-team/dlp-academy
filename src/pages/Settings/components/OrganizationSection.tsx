...
const OrganizationSection = ({ viewMode, rememberSort, onUpdate }: any) => {
  return (
    <section>
          ...
          <div className="p-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 dark:text-slate-400">Se aplica cuando no recuerdas la organización</p>
              </div>
            </div>
