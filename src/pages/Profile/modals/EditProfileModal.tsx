...
const EditProfileModal = ({ isOpen, onClose, initialData, onSave }: any) => {
    ...
    const uploadProfileImage = async (file, userId: any) => {
    ...
    return (
        <BaseModal
            ...
            backdropClassName="absolute inset-0 bg-black/50 dark:bg-slate-900/80 backdrop-blur-sm"
            contentWrapperClassName="relative z-10 flex min-h-full items-center justify-center p-4"
            contentClassName="bg-white dark:bg-gray-800 rounded-2xl shadow-xl w-full max-w-md overflow-hidden animate-fadeIn border border-transparent dark:border-gray-700"
        >
