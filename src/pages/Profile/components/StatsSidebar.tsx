...
// ─── Badges Overlay ────────────────────────────────────────────────────────────
const BadgesOverlay = ({ badges, onClose }: any) => {
    const earnedKeys = new Set((badges || []).map((b: any) => b.key));
...
// ─── Inline Badges Card ────────────────────────────────────────────────────────
const BadgesCard = ({ badges = [], onClick }: any) => {
    const earnedKeys = new Set((badges || []).map((b: any) => b.key));
    const earnedCount = earnedKeys.size;
...
// ─── Main StatsSidebar ─────────────────────────────────────────────────────────
const StatsSidebar = ({ chartData = [], role = 'student', loading = false, badges = [], showBadges = true }: any) => {
