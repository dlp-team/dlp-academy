...
const QuizCard = ({
    ...
    const getQuizIcon = (type, level: any) => {
        if (level) {
        ...
        >
            ...
            <div className="relative bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl h-full flex flex-col group-hover:border-slate-300 dark:group-hover:border-slate-700 transition-all duration-300">
                ...
                <div className="relative p-4 flex flex-col gap-3 flex-1">
                    ...
                    <div className="flex items-center justify-between gap-2">
                        ...
                        {permissions?.canEdit && (
                            <div className="flex items-center gap-0.5">
                                <button
                                    onClick={(e: any) => { e.stopPropagation(); navigate(`/home/subject/${subjectId}/topic/${topicId}/quiz/${quiz.id}/edit`); }}
                                ...
                                <button
                                    onClick={(e: any) => { e.stopPropagation(); if (deleteQuiz) deleteQuiz(quiz.id); }}
                    ...
                    {/* Action button */}
                    <button
                        onClick={(e: any) => { e.stopPropagation(); navigate(`/home/subject/${subjectId}/topic/${topicId}/quiz/${quiz.id}`); }}
