...
const QuestionCard = React.memo(({ questionNumber, question, formula, topicGradient }: any) => (
    <div className="relative mb-8 group">
        ...
        <div className="relative bg-white/90 dark:bg-slate-900/90 backdrop-blur-2xl rounded-[2rem] p-8 md:p-10 shadow-xl border border-white/50 dark:border-slate-700/70 overflow-hidden">
            {/* Top accent */}
            ...
            <h2 className="text-2xl md:text-3xl font-black text-slate-900 dark:text-white leading-relaxed text-center relative z-10">
            ...
            {formula && (
                <div className="mt-8 bg-gradient-to-br from-slate-50 to-white dark:from-slate-800 dark:to-slate-900 rounded-2xl p-6 border border-slate-100 dark:border-slate-700/70 shadow-inner">
