                        ...
                        {typeof window !== 'undefined' && window.document && createPortal(
                            <>
                                ...
                                >
                                    ...
                                    <button 
                                        onClick={(e: any) => { e.stopPropagation(); onShare && onShare(subject); setShowMenu(false); }}
                                    ...
                                    <button
                                        onClick={(e: any) => { e.stopPropagation(); onOpenClasses && onOpenClasses(subject); setShowMenu(false); }}
                                    ...
                                    {canShowShortcutDelete && (
                                        <button 
                                            onClick={(e: any) => { e.stopPropagation(); onDelete(subject, (isOrphan || disableUnshareActions) ? 'deleteShortcut' : 'unshareAndDelete'); setShowMenu(false); }}
                                    ...
                                    <button 
                                        onClick={(e: any) => { e.stopPropagation(); onDelete(subject, 'delete'); setShowMenu(false); }}
                    ...
                    <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
                        {isMovedToShared && subject?._movedToFolderId ? (
                            <div className="pointer-events-auto flex items-center gap-2">
                                ...
                                <button
                                    onClick={(e: any) => { e.stopPropagation(); onDelete(subject, 'deleteShortcut'); }}
