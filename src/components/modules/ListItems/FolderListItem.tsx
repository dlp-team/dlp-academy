...
const FolderListItem = ({ 
    ...
    const resolveFolderParentId = (folderEntry: any) => {
                    ...
                    <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
                        {isMovedToShared && item?._movedToFolderId ? (
                            <div className="pointer-events-auto flex items-center gap-2">
                                ...
                                <button
                                    onClick={(e: any) => { e.stopPropagation(); onDelete(item, 'deleteShortcut'); }}
            ...
            >
                <div className="overflow-hidden">
                    <div className="mt-2 flex flex-col gap-2">
                        {hasChildren ? (
                            <>
                                {childFolders.map((folder, childIndex: any) => (
                                    <ListViewItem
                                        key={folder.id}
                                        item={folder}
                                        type="folder"
                                ...
                                {childSubjects.map((subject, childIndex: any) => (
                                    <ListViewItem
                                        key={subject.id}
                                        item={subject}
                                        type="subject"
