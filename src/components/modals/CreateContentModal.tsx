...
const ToggleOptionCard = ({ field, label, icon, description, value, disabled, onToggle }: any) => (
    <button
        type="button"
        disabled={disabled}
...
const TypeSpecificOptions = ({ type, formData, setFormData, disabled }: any) => {
                    ...
                    <div className="grid grid-cols-2 gap-2">
                        {[
                            ...
                            <button
                                ...
                                disabled={disabled}
                                onClick={() => {
                                    const updates: any = { examMode: opt.value };
                        ...
                        <div className="p-6">
                            <form id="content-form" onSubmit={onSubmit} className="space-y-5">
                                ...
                                <ReferencePdfUploadField
                                    ...
                                    emptyDescription="La IA lo usará como base para el contenido"
                                />
                            </form>
                        </div>
                    )}
