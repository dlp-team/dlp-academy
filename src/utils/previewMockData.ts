...
export const PREVIEW_MOCK_SUBJECTS = [
  ...
  // Student-visible copy of Ciencias (simulates shortcut/course assignment)
  {
  ...
  'preview-subject-student-ciencias': [
    {
      ...
      name: 'Metodo cientifico',
      title: 'Metodo cientifico',
      description: 'Fases del metodo cientifico y su aplicacion.',
      number: '01',
      order: 1,
      status: 'completed',
      isVisible: true,
    ...
    },
    {
      ...
      name: 'Enlace quimico',
      title: 'Enlace quimico',
      description: 'Tipos de enlace y propiedades moleculares.',
      number: '02',
      order: 2,
      status: 'in-progress',
      isVisible: true,
