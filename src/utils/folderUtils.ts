 ...
 */
export const isDescendant = (possibleParentId, targetId, allFolders: any) => {
...
export const isTargetInsideDraggedTree = (draggedFolderId, targetFolderId, allFolders: any) => {
...
export const isInvalidFolderMove = (draggedFolderId, targetFolderId, allFolders: any) => {
    if (!draggedFolderId || !targetFolderId) return false;
    if (draggedFolderId === targetFolderId) return true;
