...
const isValidThemeTokenOverride = (value: any) => {
...
export const normalizeHexColor = (value: any) => {
...
const mixHexColors = (baseHex, mixHex, baseWeight: any) => {
...
const buildColorScale = (baseColor, fallbackColor: any) => {
...
const toRgba = (hex, alpha: any) => {
    const rgb = hexToRgb(hex);
    if (!rgb) return null;
    return `rgba(${rgb.r}, ${rgb.g}, ${rgb.b}, ${alpha})`;
};

const pickHomeThemeTokenOverrides = (candidate: any) => {
    if (!candidate || typeof candidate !== 'object') return null;

    const overrides = HOME_THEME_TOKEN_KEYS.reduce((acc, key: any) => {
...
const pickHomeThemeColorOverrides = (candidate: any) => {
    if (!candidate || typeof candidate !== 'object') return null;

    const overrides = HOME_THEME_COLOR_KEYS.reduce((acc, key: any) => {
...
export const resolveInstitutionHomeThemeOverrides = (institutionData: any) => {
...
export const resolveInstitutionHomeThemeColors = (institutionData: any) => {
    if (!institutionData || typeof institutionData !== 'object') return null;
...
export const getEffectiveHomeThemeTokens = (overrides: any) => {
    return {
        ...HOME_THEME_TOKENS,
        ...(overrides || {})
    };
...
export const getEffectiveHomeThemeColors = (overrides: any) => {
    return {
...
export const resolveInstitutionBranding = (institutionData: any) => {
    ...
    return {
        ...
        iconUrl:
            (typeof customization.iconUrl === 'string' && customization.iconUrl.trim()) ||
...
export const buildGlobalBrandCssVariables = (primaryColor: any) => {
...
export const buildHomeThemeCssVariables = (colors: any) => {
