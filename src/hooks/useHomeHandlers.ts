...
export const useHomeHandlers = ({
    ...
    const reportHomeError = (message: any) => {
    ...
    const handleDragStartSubject = (a, b: any) => {
    ...
    const handleDragStartFolder = (folder: any) => {
    ...
    const handleDragOverSubject = (e, position: any) => {
        e.preventDefault();
        setDropPosition(position);
    };

    const handleDragOverFolder = (e, position: any) => {
        e.preventDefault();
        setDropPosition(position);
    };

    const handleDropOnFolder = async (draggedId, targetFolderId, type, parentId, ...extraArgs: any) => {
    ...
    const handleNestFolder = async (targetFolderId, folderToNestId: any) => {
    ...
    const handleDropReorderSubject = (draggedId, fromPosition, toPosition: any) => {
    ...
    const handleDropReorderFolder = (draggedId, fromPosition, toPosition: any) => {
        if (draggedId === undefined || fromPosition === toPosition) return;
        const getManualKey = (item) => item?.shortcutId || item?.id;
    ...
    const handlePreferenceChange = (key, value: any) => {
