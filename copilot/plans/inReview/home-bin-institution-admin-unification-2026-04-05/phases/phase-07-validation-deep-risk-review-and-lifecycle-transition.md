<!-- copilot/plans/inReview/home-bin-institution-admin-unification-2026-04-05/phases/phase-07-validation-deep-risk-review-and-lifecycle-transition.md -->
...
- Remaining lifecycle step: final inReview closure pass before transition to `finished`.
