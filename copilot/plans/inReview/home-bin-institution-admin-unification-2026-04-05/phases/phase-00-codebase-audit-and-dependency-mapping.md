<!-- copilot/plans/inReview/home-bin-institution-admin-unification-2026-04-05/phases/phase-00-codebase-audit-and-dependency-mapping.md -->
...
## Validation Gate
- Dependency map committed in [working/implementation-order-and-dependency-map.md](copilot/plans/inReview/home-bin-institution-admin-unification-2026-04-05/working/implementation-order-and-dependency-map.md).
- Assumptions/risks documented in [working/risk-and-assumption-register.md](copilot/plans/inReview/home-bin-institution-admin-unification-2026-04-05/working/risk-and-assumption-register.md).
