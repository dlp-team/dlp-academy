<!-- copilot/plans/inReview/home-bin-institution-admin-unification-2026-04-05/README.md -->
...
- Primary source of truth: [source-original-user-spec-home-bin-institution-admin-unification.md](copilot/plans/inReview/home-bin-institution-admin-unification-2026-04-05/source-original-user-spec-home-bin-institution-admin-unification.md)
- Secondary structure reference: [source-gemini-structured-reference-home-bin-institution-admin-unification.md](copilot/plans/inReview/home-bin-institution-admin-unification-2026-04-05/source-gemini-structured-reference-home-bin-institution-admin-unification.md)
...
1. Run final inReview closure pass across review artifacts and residual risk checks.
2. Prepare transition package from `inReview` to `finished`.
