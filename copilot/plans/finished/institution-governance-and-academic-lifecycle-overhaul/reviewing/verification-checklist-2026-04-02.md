<!-- copilot/plans/finished/institution-governance-and-academic-lifecycle-overhaul/reviewing/verification-checklist-2026-04-02.md -->
...
- 2026-04-02 (Lifecycle closure):
	- Canonical plan package transitioned from `inReview` to `finished`.
	- Duplicate active snapshot archived to prevent lifecycle drift.
	- Path-header comments synchronized to final folder locations.
