...
- Reporte lossless generado en `copilot/explanations/temporal/lossless-reports/2026-02-28/home-merge-users-propagation.md`.
- Próximo paso: smoke test manual UI y cierre a `finished/`.
