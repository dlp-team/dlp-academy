...
## Initial Tasks
- [x] Create utility module under `src/utils/` for drag payload helpers.
- [x] Migrate list-mode item components to helper usage.
- [x] Migrate Tree modal `TreeItem` and root drop parser to helper usage.
...
- Implemented utility: `src/utils/dragPayloadUtils.js`.
- First adopters: `ListViewItem.jsx` and `FolderTreeModal.jsx`.
