...
- Re-run after credential fix:
  ...
  - `tests/e2e/home-sharing-roles.spec.js` (extended drag checks): 4 passed / 1 skipped (skip reason: fixture currently lacks shared-folder access for one role path).
