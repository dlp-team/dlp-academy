<!-- copilot/plans/active/component-centralization-deep-audit-2026-04-07/strategy-roadmap.md -->
# Strategy Roadmap
...
| 05 | Button and form primitive centralization | IN_PROGRESS | Repeated action and input patterns replaced with reusable primitives where safe |
...
- Phase 05 in progress with first shared form primitive (ReferencePdfUploadField) adopted by AI modals.
