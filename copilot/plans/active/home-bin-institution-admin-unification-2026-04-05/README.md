...
1. Continue Phase 04 Block C slice 2 with topic/resource/bin real-surface parity hardening.
2. Expand deterministic preview parity assertions for header + content composition integration behavior.
