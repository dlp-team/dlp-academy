...
1. Continue Phase 04 Block C slice 3 with topic/resource/bin real-surface parity hardening.
2. Add deterministic preview assertions for topic/resource/bin composition transitions.
