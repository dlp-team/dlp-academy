# Step Checklist — LIA YYYY-MM-DD

> **LIA Instance:** `lia-YYYY-MM-DD` | **Executor:** [EXECUTOR]  
...
| 1.6 | ⬜ | Create direct institutionadmin invite for `admin.lia.YYYYMMDD@dlptest.dev` |
...
| # | Status | Step |
|---|--------|------|
| 2.1 | ⬜ | Register with invite: `admin.lia.YYYYMMDD@dlptest.dev` |
...
| # | Status | Step |
|---|--------|------|
| 3.1 | ⬜ | Institution admin creates teacher invite for `teacher1.lia.YYYYMMDD@dlptest.dev` |
| 3.2 | ⬜ | Teacher invite doc in Firestore with `role: 'teacher'` |
| 3.3 | ⬜ | Create second teacher invite for `teacher2.lia.YYYYMMDD@dlptest.dev` |
...
| 8.2 | ⬜ | [EMULATOR] Cross-institution subject read denied |
...
| 8.7 | ⬜ | [EMULATOR] Cannot assign subject from Institution B to class in Institution A |
| 8.8 | ⬜ | [EMULATOR] Unauthenticated Firestore reads denied on all collections |
| 8.9 | ⬜ | [EMULATOR] User create with `role: 'admin'` denied by Firestore rule |
| 8.10 | ⬜ | Used invite code cannot be reused by second registration |
| 8.11 | ⬜ | Invite code atomic collision retry works (no duplicate codes) |
| 8.12 | ⬜ | [EMULATOR] Cross-institution invite code student enrollment denied |
...
| # | Status | Step |
|---|--------|------|
| 9.1 | ⬜ | Update `working-features-baseline.md` with all ✅ features from this run |
...
| 9.8 | ⬜ | Test institution data cleaned from Firestore (or archive doc noted) |
| 9.9 | ⬜ | Test Auth users cleaned or archived |
