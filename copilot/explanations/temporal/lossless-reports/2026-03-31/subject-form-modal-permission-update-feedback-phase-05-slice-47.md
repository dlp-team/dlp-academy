<!-- copilot/explanations/temporal/lossless-reports/2026-03-31/subject-form-modal-permission-update-feedback-phase-05-slice-47.md -->
# Lossless Report - Phase 05 Slice 47 SubjectFormModal Permission-Update Feedback Hardening
...
## Delivered Scope
- Hardened `src/pages/Subject/modals/SubjectFormModal.jsx` apply-all permission-update mutation feedback.
- Added permission-specific per-user failure detail for denied permission-update writes.
- Preserved generic per-user failure detail for non-permission permission-update failures.
...
7. `copilot/explanations/temporal/lossless-reports/2026-03-31/subject-form-modal-permission-update-feedback-phase-05-slice-47.md`
...
## Residual Risks
- Apply-all update failure feedback remains grouped inline; there is no per-user retry action.
