...
## Purpose
- **Source file:** `src/components/modules/FolderCard/FolderCardTab.jsx`
...
### FolderCardTab
- **Type:** const arrow
- **Parameters:** `{ isModern`, `gradientClass`, `scaleMultiplier }`
...
## Example
```jsx
import FolderCardTab from '../components/modules/FolderCard/FolderCardTab';

function ExampleScreen() {
  return <FolderCardTab />;
}
```
