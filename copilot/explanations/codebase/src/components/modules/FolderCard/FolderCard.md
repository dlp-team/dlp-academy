...
## Changelog
- **2026-04-12:** Forwarded click event payload through `onOpen(folder, event)` so Home can apply modifier-aware selection/navigation rules without breaking existing folder-open behavior.
