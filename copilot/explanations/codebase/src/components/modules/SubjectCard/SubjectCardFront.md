...
## Changelog
- **2026-04-12:** Subject card front click now forwards native click events in `onSelect(subject.id, event)` so Home can apply modifier-aware selection/open shortcuts without losing existing click behavior.
