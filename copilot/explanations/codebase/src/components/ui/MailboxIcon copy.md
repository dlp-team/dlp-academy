# MailboxIcon copy.jsx

## Purpose
- **Source file:** `src/components/ui/MailboxIcon copy.jsx`
...
### MailboxIcon
- **Type:** const arrow
- **Parameters:** `{ mailCount = 0`, `onClick }`
...
## Example
```jsx
import MailboxIcon copy from '../components/ui/MailboxIcon copy';

function ExampleScreen() {
  return <MailboxIcon copy />;
}
```
