...
## Changelog
- 2026-04-12: Removed page-local `.custom-scrollbar` WebKit overrides so Exam scroll surfaces inherit centralized global scrollbar styles from `src/index.css` with live theme-token updates.
