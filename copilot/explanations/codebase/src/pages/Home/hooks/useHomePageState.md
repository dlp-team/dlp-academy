...
## Changelog
- **2026-04-12:** Extended `shareConfirm` and `unshareConfirm` initial payloads with `selectionPreview` metadata so batch move confirmations can render selected-item previews without shape drift.
